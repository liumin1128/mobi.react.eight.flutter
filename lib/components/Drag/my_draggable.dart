...
class MyDraggable<T> extends StatefulWidget {
  ...
  const MyDraggable({Key key, @required this.child, @required this.feedback, this.data, this.childWhenDragging, this.feedbackOffset: Offset.zero, this.dragAnchor: DragAnchor.child, this.affinity, this.maxSimultaneousDrags, this.onDragStarted, this.onMyDraggableCanceled, this.onDragCompleted, this.onMove})
      : assert(child != null),
  ...
  DragAvatar<T> _startDrag(Offset position) {
    ...
    final DragAvatar<T> avatar = DragAvatar<T>(
        ...
        onDragEnd: (Velocity velocity, Offset offset, bool wasAccepted) {
          ...
          if (!wasAccepted && widget.onMyDraggableCanceled != null) widget.onMyDraggableCanceled(velocity, offset);
        });
    //TODO mine
    this.avatar = avatar;

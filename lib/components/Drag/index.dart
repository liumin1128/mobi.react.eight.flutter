...
class DragAndDropList<T> extends StatefulWidget {
  ...
  DragAndDropList(this.rowsData, {Key key, @required this.itemBuilder, this.onDragFinish, @required this.canBeDraggedTo, this.dragElevation = 0.0, this.tilt = 0.0})
      : providesOwnDraggable = false,
        itemBuilderCustom = null,
        super(key: key);

  DragAndDropList.withCustomDraggableBehavior(this.rowsData, {Key key, @required this.itemBuilderCustom, this.onDragFinish, @required this.canBeDraggedTo, this.dragElevation = 0.0, this.tilt = 0.0})
...
class DraggableListItem extends StatelessWidget {
  ...
  DraggableListItem({Key key, this.data, this.index, this.onDragStarted, this.onDragCompleted, this.onAccept, this.onMove, this.cancelCallback, this.draggedHeight, this.child, this.tilt, this.dragElevation, this.delegate, this.custom}) : super(key: key);

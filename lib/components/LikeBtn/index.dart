    ...
    return Stack(
      ...
      children: <Widget>[
        ...
        CustomPaint(
          ...
          painter: CirclePainter(innerCircleRadiusProgress: innerCircle.value, outerCircleRadiusProgress: outerCircle.value, startColor: widget.circleStartColor, endColor: widget.circleEndColor),
        ),
        GestureDetector(
          onTap: _onTap,
          child: Container(

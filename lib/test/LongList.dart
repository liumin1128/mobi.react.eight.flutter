        ...
        body: new ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
              ...
              Container(padding: const EdgeInsets.symmetric(horizontal: 16), alignment: Alignment.topLeft, child: Text('xxxxxxxxxx', style: Theme.of(context).textTheme.body1.copyWith(color: Colors.black87))),
              Container(
